<template>
  ...
  <view class="bg-primary min-h-full">
    ...
    <!-- #endif  -->
    <view :style="{ 'margin-top': navBarHeight + menuTop + 'px' }">
      <van-tabs
        :active="tabIndex"
        sticky
        :animated="false"
      ...
      <view v-if="cartData.length">
        ...
        <view v-show="cartData[tabIndex].isNull || !token">
          <view class="nullCart">
            ...
            <text style="color: #BFC2CC;">您的购物车还是空的哦～</text>
          </view>
          <view class="plr30 ptb40 row space-between">
            <!-- #ifdef H5 -->
            <view
              class="fw600 h88 l-h88 text-center radius bg-pink color-white"
              style="width: 46%;"
              @tap="toRecommend"
              >查看更多商品</view
            >
            ...
            <navigator
              ...
              style="width: 46%;"
            >
              <view class="fw600 h88 l-h88 text-center radius bg-pink color-white"
                >查看更多商品</view
              >
            </navigator>
            <!-- #endif -->
            ...
            <navigator url="/pagesA/integral/Task" style="width: 46%;">
              <view
                class="fw600 h88 l-h88 text-center radius color-pink-simple bg-white"
                >玩玩喵豆游戏</view
              >
            </navigator>
            <!-- #endif -->
                ...
                <van-checkbox-group>
                  ...
                  >
                    ...
                    <view class="row hidden flex-1 hairline-bottom ptb30">
                      <view class="relative goods-img-border">
                        <view class="relative">
                          <image :src="item.skuImg" class="w-h160 radius opacity" />
                          <view class="w-h160 radius pos-center" style="background: rgba(0, 0, 0, 0.03);"></view>
                        </view>
                        <view class="absolute row w-h-full" style="top:0;">
                          <view class="disabledCart-tag">{{
...
export default {
  ...
  methods: {
    ...
    toRecommend() {
      // #ifdef H5
      this.$flutter({ method: "TO_HOME", data: { index: 0 } });
      // #endif
    },
